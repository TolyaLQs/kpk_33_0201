...
class Student(Human):
    ...
    def __init__(self, first_name, last_name, height, weight, *args, **kwarqs):
        super().__init__(first_name, last_name, *args, **kwarqs)
        self.height = height
        self.weight = weight
...
class Teacher(Human):
    def __init__(self, first_name, last_name, education, exerience, *args, **kwarqs):
        super().__init__(first_name, last_name, *args, **kwarqs)
        self.education = education
        self.exerience = exerience
